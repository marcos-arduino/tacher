...
<body>
    ...
    <div class="container centrar">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-4">
                <form id="form" method="POST" action="loginCTRL.php">
                    <?php if (isset($_GET["rgt"]) and $_GET["rgt"] == "0") { ?>
                        <script>
                            alert("El usuario no se pudo ingresar correctamente. Quizás no está registrado o se ingresaron mal los datos de inicio de sesión.");
                        </script>
                    <?php } ?>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary w-100 text-uppercase fw-bold">Iniciar Sesion</button>
                </form>
            </div>
        </div>
    </div>
